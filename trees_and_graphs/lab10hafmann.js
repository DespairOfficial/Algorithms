...
// Алгоритм Хаффмана должен каждый раз находить два корневых узла с наименьшим весом из F. После построения нового дерева удалите эти два корневых узла и добавьте вновь построенное дерево. Этот процесс использует наименьшую кучу для достижения максимальной Подходящее. Сначала добавьте корневой узел леса в минимальную кучу, выполните цикл n – 1 раз, каждый цикл, удалите вершину наименьшей кучи дважды подряд, используйте эти две кучи Вверху постройте новое дерево и поместите корневой узел нового дерева в самую маленькую кучу. Верхняя часть кучи является корневым узлом дерева Хаффмана. Определяем класс, в котором хранятся код и вероятность
str1 = "Алго"
let  dict = {
}
